...
export const points: { attributes: string[]; points: number[] }[] = [
  ...
  { attributes: ["adaptability, independence, patience"], points: [1, 1, 1] },
  {
  ...
  { attributes: ["creativity, analytics, independence"], points: [1, 1, 1] },
  { attributes: ["teamwork, leadership, decision making"], points: [1, 1, 1] },
  ...
  { attributes: ["analytics, communication, leadership"], points: [1, 1, 1] },
  { attributes: ["creativity, organization"], points: [1, 1] },
